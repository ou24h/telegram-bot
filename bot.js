...
exec(`./yt-dlp "ytsearch5:${query} site:soundcloud.com" --match-filter "url~='soundcloud.com'" --no-playlist --no-warnings --force-ipv4 --extract-audio --audio-format mp3 --ffmpeg-location "${ffmpegPath}" -o "${filePath}"`, (err, out, errOut) => {
